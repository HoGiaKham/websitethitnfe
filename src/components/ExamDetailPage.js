      ...
      <div className="exam-stats">
        <div className="stat-card">
          ...
          <div className="stat-info">
            <div className="stat-value">{examData.subject?.name}</div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            <div className="stat-value">{examData.duration} phút</div>
        ...
        <div className="stat-card">
          <div className="stat-icon">📝</div>
          <div className="stat-info">
            <div className="stat-value">{questions.length} câu</div>
        ...
        <div className="stat-card highlight">
          <div className="stat-icon">🎯</div>
          <div className="stat-info">
            <div className="stat-value">{calculateTotalPoints().toFixed(1)} điểm</div>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="editor-toolbar">
                <button type="button" onClick={() => applyFormat('bold')} title="Đậm">
                  <strong>B</strong>
                </button>
                <button type="button" onClick={() => applyFormat('italic')} title="Nghiêng">
                  <em>I</em>
                </button>
                ...
                <button type="button" onClick={insertImageIntoEditor} title="Thêm ảnh">
                  🖼️ Ảnh
                </button>
              </div>
              <div
